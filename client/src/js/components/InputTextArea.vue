...
Message(:field="field")
  .input-group(v-if="suffix")
    textarea.form-control(:type="typeName", :placeholder="placeholder", :value="value",
  ...
  textarea.form-control(v-if="!suffix", :type="typeName", :placeholder="placeholder", :value="value",
      @input="onInput", @keydown.enter="onEnter", :disabled="updating")
</template>
